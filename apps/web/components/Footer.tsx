...
export function Footer() {
  ...
  return <footer className="site-footer"><div className="shell footer-grid">
    ...
    <div><strong>平台导航</strong><Link href="/categories">商品分类</Link><Link href="/shops">全部店铺</Link><Link href="/gateways">中转站排行</Link><Link href="/projects">热门项目</Link></div>
    <div><strong>商家服务</strong><Link href="/submit">提交店铺</Link><Link href="/shops">店铺认领</Link><Link href="/messages">反馈问题</Link></div>
